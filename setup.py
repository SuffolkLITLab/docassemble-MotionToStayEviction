...
setup(name='docassemble.MotionToStayEviction',
      ...
      install_requires=['docassemble.AssemblyLine','docassemble.MassAccess','docassemble.MassAppealsCourt>=0.2.3', 'docassemble-EFSPIntegration>=1.4.1', 'docassemble-ALAffidavitOfIndigency>=2.1.2', 'docassemble-MACourts>=0.0.58.3'],
      zip_safe=False,
